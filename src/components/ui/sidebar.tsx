        ...
        <div
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ...
              : 'group-data-[collapsible=icon]:w-sidebar-icon group-data-[side=left]:border-r group-data-[side=right]:border-l border-sidebar-border',
            className,
          )}
          {...props}
        >
          <div
            ...
            className={cn(
              ...
              (variant === 'floating' || variant === 'inset') &&
                'rounded-xl border border-sidebar-border bg-card shadow-sm',
            )}
          >
            {children}
          </div>
...
const SidebarGroupContent = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn('w-full text-[length:var(--text-body-sm)]', className)}
      {...props}
    />
  ),
)
...
const SidebarMenuBadge = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn(
        'pointer-events-none absolute right-1 flex h-5 min-w-5 select-none items-center justify-center rounded-md px-1 text-[length:var(--text-caption)] font-medium tabular-nums text-sidebar-foreground',
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        size === 'md' && 'text-[length:var(--text-body-sm)]',
        'group-data-[collapsible=icon]:hidden',
        className,
      )}
      {...props}
