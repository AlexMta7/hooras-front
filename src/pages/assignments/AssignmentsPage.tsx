...
import { useAssignments, useSetAssignmentSupervisor } from '@/api/hooks'
...
export function AssignmentsPage() {
  ...
  return (
    <div className="mx-auto max-w-[var(--page-max-width)] px-4 py-10 sm:px-10">
      <PageHeader
        title="Assignments"
        description="View project assignments and manage supervisors."
      />
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <h2 className="font-semibold text-foreground">{assignment.studentRef}</h2>
